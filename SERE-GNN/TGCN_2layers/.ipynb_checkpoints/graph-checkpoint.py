...
class Graph(object):
    ''' Note: adj_list shows each edge twice. So edge_num is really two times of edge number for undirected graph_only_2.txt.'''
    ...
    def __init__(self, node_num, edge_num):
        ...
        self.cmap = np.zeros(node_num, dtype=np.int32) - 1  # mapped to coarser graph_only_2.txt
