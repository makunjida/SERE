...
flags.DEFINE_integer('FFNN_num_hidden_layers', 2,'the number of the hidden layers of ffnn function')
...
flags.DEFINE_integer('node_wgt_embed_dim', 8, 'Number of units for node weight embedding.')
